...
public class TimesheetRest {
    ...
    public TimesheetRest(final TimesheetEntryService es, final TimesheetService ss, final CategoryService cs,
                         ...
                         final DBUtil df, final ConfigService ahcs, final MailService mS,
    ...
    public Response getTimesheetIDForUser(@Context HttpServletRequest request,
        ...
        try {
            ...
            //TODO: fix it, please only use user key instead of usernames, because last one can renamed
            // so only user keys are unique
            sheet = null; // only against compiler errors
    ...
    public Response postTimesheetHours(@Context HttpServletRequest request,
        ...
        /*
        TODO: yes the same is here, please avoid username instead use the key
...
TODO:
        ...
        */
        return Response.ok("not a valid message!! FIx it!").build();
    }
    ...
    private void sendEmailNotification(String emailTo, String reason, Timesheet sheet, UserProfile user) {
        ...
        if (reason == "time") { // TODO: what the heck is this?!?!?!
            ...
            mailBody = config.getMailBodyTime() != null && config.getMailBodyTime().length() != 0
                    ...
                    "Best regards,\n" +
                    "Catrobat-Admins";
        } else if (reason == "inactive") {// TODO: what the heck is this?!?!?!
            ...
            mailBody = config.getMailBodyInactive() != null && config.getMailBodyInactive().length() != 0
                    ...
                    "Best regards,\n" +
                    "Catrobat-Admins";
        } else if (reason == "entry") {// TODO: what the heck is this?!?!?!
