...
public class TeamManagementServlet extends HttpServlet {
    ...
    public TeamManagementServlet(UserAccessor userAccessor, GroupManager groupManager, UserManager userManager, LoginUriProvider loginUriProvider, Object templateRenderer, TeamService teamService) {
    ...
    if (loggedInUsername == null) {
      ...
      //renderer.render("teams.vm", paramMap, response.getWriter());
    } else {
      Map<String, Object> paramMap = Maps.newHashMap();
      paramMap.put("messageWithHtml", "You don't have sufficient permission to access this page!");
      response.setContentType("text/html;charset=utf-8");
      //TODO: fix it: argumente sind falsch!
      //renderer.render("error.vm", paramMap, response.getWriter());
      */
    }
